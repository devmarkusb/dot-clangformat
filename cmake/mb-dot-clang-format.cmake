...
get_filename_component(_MB_DOT_CLANG_FORMAT_REPO_ROOT "${CMAKE_CURRENT_LIST_DIR}/.." ABSOLUTE)

function(mb_dot_clang_format_install)
  if(NOT MB_DOT_CLANG_FORMAT_ENABLE)
    message(STATUS "mb-dot-clang-format: disabled (MB_DOT_CLANG_FORMAT_ENABLE=OFF)")
    return()
  endif()

  find_package(Python3 COMPONENTS Interpreter REQUIRED)

  set(_script "${_MB_DOT_CLANG_FORMAT_REPO_ROOT}/python/mb-dot-clang-format.py")
  if(NOT EXISTS "${_script}")
    message(FATAL_ERROR "mb-dot-clang-format: missing ${_script}")
  endif()

  if(NOT DEFINED MB_DOT_CLANG_FORMAT_OUTPUT OR "${MB_DOT_CLANG_FORMAT_OUTPUT}" STREQUAL "")
  ...
  if(MB_DOT_CLANG_FORMAT_FORCE_CONFIG_VERSION AND NOT "${MB_DOT_CLANG_FORMAT_FORCE_CONFIG_VERSION}" STREQUAL "")
    list(APPEND _py_cmd --force-config-version "${MB_DOT_CLANG_FORMAT_FORCE_CONFIG_VERSION}")
  elseif(NOT "${MB_DOT_CLANG_FORMAT_CLANG_FORMAT_MAJOR}" STREQUAL "")
    list(APPEND _py_cmd --clang-format-major "${MB_DOT_CLANG_FORMAT_CLANG_FORMAT_MAJOR}")
  endif()
